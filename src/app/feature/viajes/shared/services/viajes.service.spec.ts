...
describe('ViajesService', () => {
  ...
  const apiEndpointViajes = `${environment.endpoint}/viajes/conductor-viajes/1`;

  beforeEach(() => {
    const injector = TestBed.configureTestingModule({
      imports: [HttpClientTestingModule],
      providers: [ViajesService, HttpService]
    });
  ...
  it('deberia listar Viaje', () => {
    ...
    const req = httpMock.expectOne(apiEndpointViajes);
